...
void EmptyLinkFunctionForGeneratedCodeFF_RealSense_init() {}
	...
	FORCENOINLINE UPackage* Z_Construct_UPackage__Script_FF_RealSense()
	{
		if (!Z_Registration_Info_UPackage__Script_FF_RealSense.OuterSingleton)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				...
				(UObject* (*)())Z_Construct_UDelegateFunction_FF_RealSense_RsDelegateRotation__DelegateSignature,
			};
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferPackage_UPackage__Script_FF_RealSense(Z_Construct_UPackage__Script_FF_RealSense, TEXT("/Script/FF_RealSense"), Z_Registration_Info_UPackage__Script_FF_RealSense, CONSTRUCT_RELOAD_VERSION_INFO(FPackageReloadVersionInfo, 0xBECC25D7, 0xEEA67F2E));
